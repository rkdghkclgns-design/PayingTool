            ...
            {sortedProducts.map((product) => (
              <tr key={product.id} className="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                ...
                <td className="py-3 px-2 text-right whitespace-nowrap">
                  <span className="font-medium text-gray-900 dark:text-gray-100">{formatUSD(product.priceUSD)}</span>
                  <span className="ml-1 text-gray-400 text-xs">({formatKRW(product.priceKRW)})</span>
                </td>
                <td className="py-3 px-2">
